...
> **시험해볼 노트가 없다면** 이 저장소에 예제 vault가 들어 있습니다 —
> [`demo-vault/`](demo-vault), 74개 노트에 역링크·중첩 태그 트리·frontmatter 상호참조가
> 아래 기능이 전부 보이도록 짜여 있습니다. 1번에서 이 폴더를 고르세요.
> 설명은 [`demo-vault/README.md`](demo-vault/README.md).
